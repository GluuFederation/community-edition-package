...
app_versions = {
              ...
              "SETUP_BRANCH": "version_4.2.3",
              "PASSPORT_NODE_VERSION": "4.2.3",
...
if '-x' in sys.argv:
    download('https://raw.githubusercontent.com/GluuFederation/community-edition-package/master/ce-host/4.2.3/dependencies.sh'.format(), 'opt/gluu/bin/dependencies.sh')

download('https://raw.githubusercontent.com/GluuFederation/community-edition-package/master/ce-host/4.2.3/gluu-serverd'.format(), 'usr/sbin/gluu-serverd')
download('https://raw.githubusercontent.com/GluuFederation/community-edition-package/master/ce-host/4.2.3/gluu-server.sh'.format(), 'etc/profile.d/gluu-server.sh')
...
#./makeself.sh --tar-extra "--exclude=/opt/gluu-server-4.2.3-host/download_apps.py" --target / /opt/gluu-server-4.2.3-host gluu-server-4.2.3-host.sh "Gluu CE Package 4.2.3" /opt/gluu/bin/dependencies.sh
